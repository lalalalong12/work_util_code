package com.ywltest.springdemo.mqtt;
...
// Paho MQTT客户端。
        MqttClient sampleClient = new MqttClient("tcp://10.19.151.250:1883", InetAddress.getLocalHost().getHostAddress() + "02", new MemoryPersistence());
